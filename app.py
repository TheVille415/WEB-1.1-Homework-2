...
def show_froyo_results():
    # request.args, which stores all of the data that the user entered into the form as key-value pairs
    context = {
...
def favorites_results():
    ...
    return f'Woah! I didnt know {user_color} {user_animal} lived in {user_city}!'
